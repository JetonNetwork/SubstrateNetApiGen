...
namespace SubstrateNetApi.Model.Types.TypeDefArray
{
    ...
    public sealed class Arr3PrimU128 : BaseType
    {
        
        private new int _typeSize = 3;
        
        private PrimU128[] _value;
        
        public PrimU128[] Value
        {
            get
            {
                return this._value;
        ...
        {
            return string.Format("[{0}; {1}]", new PrimU128().TypeName(), this.TypeSize());
        }
        ...
        {
            var start = p;
            var array = new PrimU128[TypeSize()];
            for (var i = 0; i < array.Length; i++) {var t = new PrimU128();t.Decode(byteArray, ref p);array[i] = t;};
        ...
        public void Create(PrimU128[] array)
        {
            Value = array;
            Bytes = Encode();
        }
